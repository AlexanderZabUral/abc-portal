...
public class AdminService {
	...
	public List<UserProfile> listUser() {
		List<UserProfile> listOfUser = (List<UserProfile>) profileRepo.findAll();
		return listOfUser;
	}
	...
	public List<User> findAllUserById(String[] id_users){
		...
		List<User> users = (List<User>) userRepo.findAllById(IDs);
		return users;
	}
	
	public List<ApplyJob> listJobApplicant(){
		List<ApplyJob> applyJob = (List<ApplyJob>) applyJobRepo.findAll();
